...
function init() { 
	...
	// Filter for real, usable motion data
	function handleTestMotion(event) {
		if (
			...
			motionDetected = true;
			console.log("Real devicemotion detected:", event.acceleration);
	...
	setTimeout(() => {
		if (!motionDetected) {
			console.log("No usable devicemotion — fallback to manual toggle.");
